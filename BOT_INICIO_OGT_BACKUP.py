...
OGT  = web3.toChecksumAddress("0x598642f59c0366643c6f9ee3252cbb3ef1524c51")
...
_address = '0x99880727b8c522C791670e31e7Ca22902a25A2E7'
...
print(f'BNB balance = {humanReadable}')
...
contract_id = web3.toChecksumAddress(OGT)
...
amount = web3.toWei(0.0008333716975965549, 'ether')
print (amount)
...
txn = contract.functions.swapExactETHForTokens(0,[WBNB,OGT],_address,(int(time.time()) + 1000)).buildTransaction({
'from': _address,
'value': amount,#This is the Token(BNB) amount you want to Swap from
'gas': 250000,
'gasPrice': web3.toWei('5','gwei'),
'nonce': web3.eth.get_transaction_count(_address),
})
    
signed_txn = web3.eth.account.sign_transaction(txn, private_key=config.private)
tx_token = web3.eth.send_raw_transaction(signed_txn.rawTransaction)
print(f"TOKEN {symbol}: " + web3.toHex(tx_token))
